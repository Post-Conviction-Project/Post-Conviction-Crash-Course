      ...
      <>
        ...
        <div className="section">
          ...
          <ul className="list-items">
            ...
            <li><strong>Failed to communicate a plea offer</strong> — the state extended a plea deal and the attorney never told the client, or told them too late. Under <a href="/missouri-v-frye.pdf" target="_blank" rel="noopener noreferrer" className="tag tag-case" style={{textDecoration:"none",cursor:"pointer"}}>Missouri v. Frye</a> and <a href="/lafler-v-cooper.pdf" target="_blank" rel="noopener noreferrer" className="tag tag-case" style={{textDecoration:"none",cursor:"pointer"}}>Lafler v. Cooper</a>, defendants have a Sixth Amendment right to be informed of plea offers. This is a big one.</li>
